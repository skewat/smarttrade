...
HOLIDAYS = [
    ...
    "2025-01-01", "2025-01-26", "2025-02-26", "2025-03-14", "2025-03-31", "2025-04-06", "2025-04-10",
    "2025-04-14", "2025-04-18", "2025-05-01", "2025-06-07", "2025-07-06", "2025-08-15", "2025-08-27",
    "2025-10-02", "2025-10-21", "2025-10-22", "2025-11-05", "2025-12-25"
    ]

def is_weekend(date_str):
    """
    Check if the given date (in 'YYYY-MM-DD' format) falls on a Saturday or Sunday.
    """
...
def is_holiday(date_str):
    """
    Return True if the date is a weekend or in the fixed holiday list.
    """
    if not type(date_str) == type(' '):
        date_str = date_str.strftime("%Y-%m-%d")

    return date_str in HOLIDAYS or is_weekend(date_str)
